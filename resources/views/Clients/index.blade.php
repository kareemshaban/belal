                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button type="button" class="btn btn-danger deleteBtn" value="{{ $client -> id }}"> <iconify-icon icon="mynaui:trash-solid" style="font-size: 25px"></iconify-icon> </button>
                                                <button type="button" class="btn btn-success editBtn" value="{{ $client -> id }}"> <iconify-icon icon="akar-icons:edit" style="font-size: 25px"></iconify-icon> </button>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
