                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div style="display: flex ; justify-content: space-between ; align-items: center">
                        <h4 class="fw-bold py-3 mb-4">
                            <span class="text-muted fw-light">{{__('main.cars_department')}} /</span> {{__('main.cars_list')}}
                        </h4>
                    ...
                    <!-- Responsive Table -->
                    <div class="card">
                        <h5 class="card-header">{{__('main.cars_list')}}</h5>
                        ...
                        <div class="table-responsive  text-nowrap">
                            <table class="table table-striped table-hover">
                                ...
                                <tr class="text-nowrap">
                                    ...
                                    <th class="text-center">{{__('main.car_number')}}</th>
                                    <th class="text-center">{{__('main.driver_name')}}</th>
                                ...
                                @foreach($cars as $car)
                                    <tr>
                                        ...
                                        <td class="text-center">{{$car -> car_number}}</td>
                                        <td class="text-center">{{$car -> driver_name}}</td>
                                        <td class="text-center">
                                                ...
                                                <div style="display: flex ; gap: 10px ; justify-content: center ">
                                                    <i class='bx bxs-edit-alt text-success editBtn' data-toggle="tooltip" data-placement="top" title="{{__('main.edit_action')}}"
                                                       id="{{$car -> id}}" style="font-size: 25px ; cursor: pointer"></i>
    ...
    $(document).on('click', '#createButton', function (event) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $(".modal-body #id").val(0);
                $(".modal-body #code").val("");
                $(".modal-body #car_number").val("");
                $(".modal-body #driver_name").val("");
                ...
                if(response){
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            $(".modal-body #car_number").val( response.car_number );
                            $(".modal-body #driver_name").val( response.driver_name );
