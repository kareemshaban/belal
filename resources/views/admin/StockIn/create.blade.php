                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div style="display: flex ; justify-content: space-between ; align-items: center">
                        <h4 class="fw-bold py-3 mb-4">
                            <span class="text-muted fw-light">{{__('main.accounting_department')}} /</span> {{__('main.stock_in_add')}}
                        </h4>

                        <button type="button" class="btn btn-primary" id="createButton" style="height: 45px"
                                onclick="valdiateRequest()">
                            {{__('main.save_btn_post')}}  <span class="tf-icons bx bx-save"></span>&nbsp;
                        </button>
                    ...
                    <!-- Responsive Table -->
                    <div class="card">
                        <h5 class="card-header">{{__('main.stock_in_add')}}</h5>
                        @include('flash-message')
                        <div class="card-content" style="padding-right: 20px ; padding-left: 20px ; padding-bottom: 20px">
                            <form class="center" method="POST" action="{{ route('stock_in_store') }}"
                                    ...
                                    <div class="col-md-6 col-lg-4 col-sm-12" style="margin-top: 10px">
                                        <div class="form-group">
                                            ...
                                            <select  name="meal_id" id="meal_id"
                                                     class="form-control @error('meal_id') is-invalid @enderror"  required>
                                    ...
                                    <div class="table-responsive  text-nowrap">
                                        <table class="table table-striped table-hover view_table">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{$meals[0] -> quantity}}</td>
                                                <td class="text-center">{{$meals[0] -> weight}}</td>
