        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="smallBody">
                ...
                <div class="container-fluid">
                    <form class="center" method="POST" action="{{ route('car_meals-carryingOver') }}"
                        ...
                        <div class="row" style="margin-top: 10px">
                            <div class="col-6">
                                <div class="form-group">
                                    <label>{{ __('main.actual_buffalo_weight') }} <span style="font-size: 14px ; color: red">*</span> </label>
                                    <input type="number" step="any"  name="actual_buffalo_weight" id="actual_buffalo_weight"
                                           class="form-control @error('actual_buffalo_weight') is-invalid @enderror"
                                           placeholder="0" autofocus required />
                                    @error('actual_buffalo_weight')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                    @enderror
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label>{{ __('main.actual_bovine_weight') }} <span style="font-size: 14px ; color: red">*</span> </label>
                                    <input type="number" step="any"  name="actual_bovine_weight" id="actual_bovine_weight"
                                           class="form-control @error('actual_bovine_weight') is-invalid @enderror"
                                           placeholder="0" autofocus required />
                                    @error('actual_bovine_weight')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                    @enderror
                    ...
                    <div class="row" style="margin-top: 40px" id="action_row">
                        <div class="col-12 text-center">
                            <button type="button" class="btn btn-primary" onclick="valdiateRequest()">{{ __('main.save_btn_post') }}</button>
