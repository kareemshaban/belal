                ...
                <div class="container-fluid">
                    ...
                    <form class="center" method="POST" action="{{ route('items-store') }}"
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label>{{ __('main.default_selling_price') }}  </label>
                                    <input type="number" step="any" name="default_selling_price" id="default_selling_price"
                                           class="form-control @error('default_selling_price') is-invalid @enderror"
                                           placeholder="{{ __('main.default_selling_price') }}" autofocus  required/>
