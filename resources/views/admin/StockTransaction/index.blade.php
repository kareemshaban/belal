        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <!-- Responsive Table -->
                    <div class="card">
                        <h5 class="card-header">{{__('main.stock_exchange_list')}}</h5>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                @foreach($docs as $doc)
                                    <tr>
                                        ...
                                        <td class="text-center">{{$doc -> store_name_to}}</td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div style="display: flex ; gap: 10px ; justify-content: center ">
                                                @if($doc -> state == 0)
                                                    ...
                                                    <a href="{{route('stock_exchange_edit' , $doc -> id)}}">
                                                ...
                                                @else
                                                    <a href="{{route('stock_exchange_view' , $doc -> id)}}">
...
<script type="text/javascript">
    ...
    function confirmDelete(id){
        let url = "{{ route('stock_exchange_delete', ':id') }}";
    ...
    function confirmPost(id){
        console.log(id);
        let url = "{{ route('stock_exchange_post', ':id') }}";
        url = url.replace(':id', id);
        document.location.href=url;
    }
