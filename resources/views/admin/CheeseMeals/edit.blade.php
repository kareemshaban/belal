                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div style="display: flex ; justify-content: space-between ; align-items: center">
                        <h4 class="fw-bold py-3 mb-4">
                            <span class="text-muted fw-light">{{__('main.cheese_department')}} /</span> {{__('main.cheese_meals_edit')}}
                        </h4>
                    ...
                    <!-- Responsive Table -->
                    <div class="card">
                        <h5 class="card-header">{{__('main.cheese_meals_edit')}}</h5>
                        @include('flash-message')
                        <div class="card-content" style="padding-right: 20px ; padding-left: 20px ; padding-bottom: 20px">
                            <form class="center" method="POST" action="{{ route('cheese_meals-update') }}"
                                    ...
                                    <div class="col-md-6 col-lg-4 col-sm-12" style="margin-top: 10px">
                                        <div class="form-group">
                                            ...
                                            <select  name="daily_milk_meal" id="daily_milk_meal" @if(Config::get('app.locale')=='ar' )
                                                dir="rtl" @endif
                                                     class="form-control @error('daily_milk_meal') is-invalid @enderror"  required>
                                                <option value=""> {{__('main.select')}} </option>
                                                @foreach($dailyMeals as $dmeal)
                                                    <option value="{{$dmeal -> id}}" @if($dmeal -> id == $meal -> daily_milk_meal)  selected @endif>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-sm-12" style="margin-top: 10px">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="any" name="average_weight_per_milk_litter" id="average_weight_per_milk_litter"
                                                   ...
                                                   value="{{$meal -> average_weight_per_milk_litter}}"/>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-sm-12" style="margin-top: 10px">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="any" name="average_productivity_per_cheese_disk" id="average_productivity_per_cheese_disk"
                                                   ...
                                                   required readonly value="{{$meal -> average_productivity_per_cheese_disk}}"/>
