        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div style="display: flex ; justify-content: space-between ; align-items: center">
                        <div style="display: flex; gap: 10px ; align-items: baseline">
                            <h4 class="fw-bold py-3 mb-4">
                                <span class="text-muted fw-light">{{__('main.accounting_department')}} /</span> {{__('main.sales')}}
                            </h4>
                            <div class="mb-3" >
                    ...
                    <!-- Responsive Table -->
                    <div class="card">
                        <h5 class="card-header">{{__('main.sales_list')}}</h5>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div style="display: flex ; gap: 10px ; justify-content: center ">
                                                @if($doc -> state == 0)
                                                    @can('page-access', [11, 'edit'])
                                                    <a href="{{route('sales_edit' , $doc -> id)}}">
                                                    ...
                                                    <i class='bx bxs-cloud-upload text-primary postBtn' data-toggle="tooltip" data-placement="top" title="{{__('main.post_sales_action')}}"
                                                       id="{{$doc -> id}}"  style="font-size: 25px ; cursor: pointer">
                                                ...
                                                @endcan
                                                @else
                                                    <a href="{{route('sales_view' , $doc -> id)}}" target="_blank">
...
@include('admin.Sales.deleteModal')
