        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="smallBody">
                ...
                <div class="row">
                    ...
                    <div class="col-6 " id="post">
                        <button type="button" class="btn btn-labeled btn-warning post-btn"  >
                            <span class="btn-label" >{{__('main.post_close_btn')}}</span></button>
                    </div>

                    <div class="col-6 " id="agree_btn">
                        <button type="button" class="btn btn-labeled btn-warning agree_btn"  >
