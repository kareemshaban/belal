                ...
                <div class="container-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row" style="margin-top: 20px">
                                <div class="col-12 text-center">
                                    <button type="button" class="btn btn-warning" style="width: 100px" onclick="filterAction()">{{ __('main.search_btn') }}</button>
                    ...
                    <div class="card">
                        <div class="card-header"style="display: flex ; justify-content: space-between ; align-items: center">
                            ...
                            <button type="button" class="btn btn-primary" style="width: 100px ; margin-right: auto">{{ __('main.print_btn') }}</button>
                                ...
                                <table class="table table table-striped  table-bordered table-hover"  >
                                    ...
                                    <tbody id="table_body">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="5"  class="text-center text-success">  {{($meal -> quantity - $meal -> outingQuantity) / 4}}  {{__('main.box')}} </td>
